    ...
    <section id="Contact" className="py-10 px-4 md:px-16 transition-all duration-300">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="flex items-center justify-center text-7xl md:text-8xl font-bold text-gray-200 dark:text-gray-700 z-0 gap-4 mb-4">
          Let's Talk
          <GoArrowUpRight className="w-24 h-24 text-green-500" />
        </h1>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
          ...
          <div className="col-span-2 space-y-6">
            ...
            {/* Submit Button */}
            <button className="flex items-center px-6 py-3mt-6  py-2 btn-dark rounded-lg font-semibold transition-all">
          ...
          <div className="col-span-1 space-y-6 w-full">
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <div className="flex items-center gap-2">
                <FaMapMarkerAlt className="text-green-500 w-24 h-10" />
            ...
            <div className="border-l-4 border-green-500 pl-4">
              <div className="flex items-center gap-2">
                <FaPhone className="text-green-500 w-24 h-10" />
                <p className="para-text">
